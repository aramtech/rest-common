...
export function recursive_select(selector: string | Array<string>, obj: any): any {
...
export const readVolatileJSON = <T extends RecursiveReadable = any>(full_path: string, options?: {
    ...
    if(!fs.existsSync(full_path)){
        if(options?.createIfNotExists && options?.defaultValue){
            ...
            fs.writeFileSync(full_path, JSON.stringify(options.defaultValue, null, 4))
